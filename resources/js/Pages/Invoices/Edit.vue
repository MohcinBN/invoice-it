...
const form = useForm({
    ...
    date_covered_start: props.invoice.date_covered_start,
    date_covered_end: props.invoice.date_covered_end,
...
<template>
    <AuthenticatedLayout>
        ...
        <form class="max-w-2xl mx-auto space-y-4" @submit.prevent="updateInvoice"> 
            <div>
